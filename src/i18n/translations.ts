...
// Supported languages: English (default), Italian, German
...
export const translations = {
  en: {
    ...
    analytics: {
      ...
      totalOwed: 'Total Share / Consumed',
  ...
  it: {
    ...
    analytics: {
      ...
      totalOwed: 'Quota Totale / Consumato',
  ...
  de: {
    ...
    sidebar: {
      ...
      currenciesFound: 'Gefundene Währungen',
      ratesDate: 'Wechselkurse',
      appliedRates: 'Angewendete Wechselkurse:',
    },
    // Dashboard
    dashboard: {
      title: 'Dashboard',
      subtitle: 'Analysiere deine gemeinsamen Ausgaben',
      overview: 'Überblick',
      ...
      expenses: 'Ausgaben',
      payments: 'Zahlungen',
      totalOperations: 'Gesamte Vorgänge',
      participants: 'Teilnehmer',
      memberBalances: 'Mitglieder-Salden',
      creditor: 'Gläubiger',
      debtor: 'Schuldner',
      paid: 'Bezahlt',
      owes: 'Schuldet',
      currencyDetails: 'Währungsdetails',
    },
    // File Upload
    upload: {
      title: 'CSV-Datei hochladen',
      dragDrop: 'Ziehe deine Splitwise CSV-Datei hierher',
      orClick: 'oder klicke zum Auswählen',
      supported: 'Unterstütztes Format: CSV',
      loading: 'Daten werden verarbeitet...',
      loaded: 'Datei geladen',
      transactionsFound: 'Transaktionen',
      membersFound: 'Mitglieder',
      remove: 'Entfernen',
      loadSample: 'Beispieldaten laden',
      loadSampleHint: 'Mit Demo-Daten testen',
    },
    // Charts
    charts: {
      categoryExpenses: 'Ausgaben nach Kategorie',
      monthlyTrend: 'Monatlicher Trend',
      clickToFilter: 'Klicken zum Filtern',
      filter: 'Filter',
      spese: 'Ausgaben',
      trasferimenti: 'Überweisungen',
      showsOnly: 'Die Transaktionstabelle zeigt nur:',
      noData: 'Keine Daten',
      amount: 'Betrag',
      count: 'Anzahl',
      groupOverall: 'Gruppe insgesamt',
      memberOnly: 'Nur Mitglied',
      compareGroup: 'Vergleich mit Gruppe',
      member: 'Mitglied',
      group: 'Gruppe',
    },
    // Transactions
    transactions: {
      ...
      share: 'Anteil ~',
      paidFull: 'Bezahlt {{amount}} (Vollständig)',
      paidEstimated: 'Geschätzt bezahlt ~ {{amount}}',
      getsBack: 'Bekommt zurück',
      inferredTooltip: 'Werte für "Bezahlt" und "Anteil" werden auf Basis der Gesamtkosten geschätzt. Für mehrausgebende Transaktionen wird nur der Nettosaldo angezeigt.',
    },
    // Analytics
    analytics: {
      title: 'Analysen',
      subtitle: 'Diagramme und detaillierte Statistiken',
      timeRange: 'Zeitraum',
      day: 'Tag',
      week: 'Woche',
      month: 'Monat',
      selectedTransactions: 'Ausgewählte Transaktionen',
      totalValue: 'Gesamtwert',
      selectRange: 'Zeitraum wählen',
      noTransactions: 'Keine Transaktionen',
      transactions: 'Transaktionen',
      categoryInsights: 'Kategorie-Einblicke',
      categoryInsightsDesc: 'Detaillierte Ausgabenanalyse nach Kategorie',
      categorySummary: 'Kategorie-Zusammenfassung',
      whoPaysWhat: 'Wer zahlt was',
      globalOverview: 'Gesamtübersicht',
      globalOverviewDesc: 'Wichtigste Statistiken und Ausgabenverteilung',
      netBalanceDistribution: 'Nettosalden-Verteilung',
      noCategories: 'Keine Kategorien',
      average: 'Durchschnitt',
      trend: 'Trend',
      total: 'Gesamt',
      fairnessAndBalance: 'Fairness & Ausgleich',
      fairnessDesc: 'Ist die Gruppe ausgeglichen? Wer zahlt mehr?',
      imbalanceOverTime: 'Ungleichgewicht im Zeitverlauf',
      fairnessIndex: 'Fairness-Index pro Mitglied',
      perMemberInsights: 'Einblicke pro Mitglied',
      spendingByCategory: 'Ausgaben nach Kategorie',
      balanceOverTime: 'Saldo im Zeitverlauf',
      flowsWithOtherMembers: 'Zahlungsflüsse mit anderen Mitgliedern',
      noDataAvailable: 'Keine Daten verfügbar',
      noFlowsWithOtherMembers: 'Keine Zahlungsflüsse mit anderen Mitgliedern',
      consumedPct: 'Verbraucht (%)',
      paidPct: 'Bezahlt (%)',
      consumed: 'Verbraucht',
      paid: 'Bezahlt',
      totalImbalance: 'Gesamtes Ungleichgewicht',
      noDataForThisCurrency: 'Keine Daten für diese Währung',
      cumulativeBalance: 'Kumulierter Saldo',
      totalPaid: 'Gesamt Bezahlt',
      totalOwed: 'Eigenanteil (Verbraucht)',
      netPosition: 'Nettoposition',
      groupBalanced: 'Die Gruppe ist ausgeglichen!',
      balanceToSettle: 'Ausgleichender Saldo',
      settlementDesc: 'Wenn heute alle ausgleichen würden, müsste der Gesamtbetrag zwischen etwa {{pairs}} Mitgliederpaaren ausgetauscht werden.',
      selectMemberToViewFlows: 'Wähle ein Mitglied aus, um Flüsse anzuzeigen',
      groupBalancedNoFlows: 'Die Gruppe ist ausgeglichen, es gibt keine Flüsse.',
    },
    // TimeRange
    timeRange: {
    ...
    categories: {
      ...
      subtitle: 'Kategorien umbenennen und zusammenführen, um deine Analyse anzupassen',
      originalCategories: 'Ursprüngliche Kategorien',
      yourGroups: 'Deine Gruppen',
      createGroup: 'Gruppe erstellen',
      groupName: 'Gruppenname',
      dragHint: 'Kategorien hierher ziehen, um sie zusammenzuführen',
      tapToAssign: 'Kategorie antippen, dann Gruppe zum Zuweisen antippen',
      ungrouped: 'Nicht gruppiert',
      deleteGroup: 'Gruppe löschen',
      emptyGroup: 'Kategorien hier ablegen',
      noData: 'Lade zuerst eine CSV-Datei hoch, um Kategorien zu verwalten',
      transactions: 'Transaktionen',
      rename: 'Umbenennen',
